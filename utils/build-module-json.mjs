...
template.url = "https://github.com/toastygm/hm-loc-jedes";
template.bugs = "https://github.com/toastygm/hm-loc-jedes/issues";
template.manifest =
    "https://github.com/toastygm/hm-loc-jedes/releases/latest/download/module.json";
template.download = `https://github.com/toastygm/hm-loc-jedes/releases/download/v${pkg.version}/module.zip`;
